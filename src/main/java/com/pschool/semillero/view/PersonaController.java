package com.pschool.semillero.view;

import com.pschool.semillero.entity.Persona;
import com.pschool.semillero.view.util.JsfUtil;
import com.pschool.semillero.view.util.JsfUtil.PersistAction;
import com.pschool.semillero.jpa.PersonaFacade;
...
public class PersonaController implements Serializable {
    ...
    @EJB
    private com.pschool.semillero.jpa.PersonaFacade ejbFacade;
    ...
    public static class PersonaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Persona) {
                ...
                return getStringKey(o.getPersonaPersona());
            } else {
